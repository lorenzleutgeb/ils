...
plot "data-3.dat" using 1:2 title 'n = 50' with linespoints , \
     "data-3.dat" using 1:5 title 'n = 100' with linespoints , \
     "data-3.dat" using 1:8 title 'n = 200' with linespoints
